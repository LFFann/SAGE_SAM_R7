...
ABLATIONS="${ABLATIONS:-full no_sam no_prior_feedback no_copy_paste no_strong_consistency no_trust_conditioned_floor no_ssl_class_balance no_prototype_anchor no_topology_filter no_prompt_consistency no_eval_topology no_boundary no_class_balance}"
