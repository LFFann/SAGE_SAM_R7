...
def summarize_run(output_dir: Path, baseline_avg_dice: float = 0.7601364254951477) -> dict[str, Any]:
    ...
    if _mean(best_window, "r6_unsup_scale") in (0.0, None):
    ...
    return {
        ...
        "c1_dice_best": _class_value(best, "dice", 1),
        "c2_dice_best": _class_value(best, "dice", 2),
